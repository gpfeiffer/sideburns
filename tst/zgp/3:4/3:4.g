...
cols:= Concatenation(
               ...
               List([53..54], i-> i + 2 * [0..1]), #3
               List([57..60], i-> i + 4 * [0..1]),
               List([65..68], i-> [i])
               );
...
fou:= chg^0;
for p in [ [57,58], [59,60], [61,62], [63,64], [67,68] ] do
    fou{p}{p}:= [[1,1],[1,-1]];
od;
...
# separate 65 from 67
# !this is equivalent to leaving 67-65 and 68-65 in potm
lst:= chg^0;
lst[67][65]:= 1;
